    ...
    */
            ...
            if (client != null)
                try {
                    ...
                    if (url != null) {
                        ...
                        values.put(Services.ACCOUNT_TYPE, account.type);
    ...
    public static class AppUpdatedReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            checkAccount(context, Constants.DEFAULT_ACCOUNT_TYPE);
            checkAccount(context, Constants.ICLOUD_ACCOUNT_TYPE);
            checkAccount(context, Constants.MI_ACCOUNT_TYPE);
        }

        private void checkAccount(Context context, String accountType) {
            final AccountManager accountManager = AccountManager.get(context);
            for (Account account : accountManager.getAccountsByType(accountType))
                try {
                    App.log.info("Checking account " + account.name + " type " + account.type);
