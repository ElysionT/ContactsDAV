...
//                    throw new DavException("Received CardDAV GET response without ETag for " + remote.location);
                    ...
                    //Call multiget for some servers unsupported ETag on GET(e.g Xiaomi)
                    multiget(bunch, downloader);
                    App.log.severe("Received CardDAV GET response without ETag for " + remote.location);
                    return;
                }
    ...
    private void multiget(DavResource[] bunch, Contact.Downloader downloader) throws IOException, HttpException, DavException, ContactsStorageException {
