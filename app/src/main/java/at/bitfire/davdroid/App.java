...
public class App extends Application {
    ...
    public static boolean FUNCTION_TEST = false;
    ...
    public final static Logger log = Logger.getLogger("contactsdav");
    static {
        at.bitfire.dav4android.Constants.log = Logger.getLogger("contactsdav.dav4android");
        at.bitfire.cert4android.Constants.log = Logger.getLogger("contactsdav.cert4android");
    }

    private static final String DEBUGGING_KEY = "android.dav.DEBUGGING";
    ...
    public void onCreate() {
        ...
        LoggingReader.DEBUGGING = debugging();
        reinitCertManager();
        reinitLogger();
    }

    public static boolean debugging(){
        return mPreferences.getBoolean(DEBUGGING_KEY, false);
    }

    public static void setDebugging(boolean debugging){
        LoggingReader.DEBUGGING = debugging;
        mPreferences.edit().putBoolean(DEBUGGING_KEY, debugging).commit();
    }

    public static void openFunctionTest() {
        FUNCTION_TEST = true;
    }
